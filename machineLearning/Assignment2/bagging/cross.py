...
from Assignment2.bagging.baggingClassifier import baggingClassifier
...
def cross_val_predict(data, modelName='decision_tree', num=10):
    ...
    for i in range(10):
        ...
        model = baggingClassifier(num, modelName)
...
lista = [[1, 2, 3] for i in range(30)]
array = np.array(lista)
split = cross_validation_split(array)
print(split)
